...
public class UserController {
    ...
    public ResponseEntity<ApplicationResponse<CustomerResponse>> registerCustomer(@Valid @RequestBody CustomerRequest request){
        CustomerResponse response = userService.registerCustomer(request);
