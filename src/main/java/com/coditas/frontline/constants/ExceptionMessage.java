...
public final class ExceptionMessage {
    ...
    public static final String FILE_FORMAT_NOT_VALID = "File format or content is not valid";
    ...
    public static final String NOT_AUTHORIZED = "You are not authorized to this resource";
